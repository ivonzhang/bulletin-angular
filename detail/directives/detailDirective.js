...
var detailPageDirectives = angular.module('detailPageDirectives', []);//创建指令模块detailPageDirectives 在app.js中的[]中引入使用

detailPageDirectives
.directive('bulletinDetail',function(){//以大写字母为分割 指令替换为 <bulletin-item>
	return {
	    restrict: 'E',//A:属性<div my-directive=”exp”></div>、 E:元素标签<my-directive></my-directive>、 C:class属性<div class=”my-directive:exp;”></div>
	    templateUrl: 'detail/directives/bulletin-detail.html', //替换模板的路径
	    //template: '<div>123</div>', //templateUrl其实跟template功能是一样的，只不过templateUrl加载一个html文件，template里的是html文件的内容
	    replace: false, //是否在html中隐藏掉定义的指令标签
